...
#### get kidney profile matrix: -------------------------------

refmat = download_profile_matrix(species = "Human", age_group = "Adult", matrixname = "Kidney_HCA")
...
svg("results/concordance with truth - kidney.svg", width = 6, height = 4)
par(mfrow = c(1,2))
par(mar = c(5,6,2,1))
